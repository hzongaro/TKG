...
compile:
	...
	(ANT_OPTS="-Xjit:{java/util/Hashtable.addEntry*}\(log=$(COMPILATION_OUTPUT)/hashtable.addentry.log,traceLocalVP,traceGlobalVP,traceCG\)" $(COMPILE_CMD) 2>&1; echo $$? ) | tee $(Q)$(COMPILATION_LOG)$(Q); \
	$(MOVE_TDUMP)
