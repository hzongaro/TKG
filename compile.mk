...
compile:
	...
	(ANT_OPTS="-Xrs -Xjit:{java/util/Hashtable.addEntry*}\(log=$(COMPILATION_OUTPUT)/hashtable.addentry.log,traceLocalVP,traceGlobalVP,traceCG\),verbose,vlog=$(COMPILATION_OUTPUT)/vlog -Xdump:system:file=$(COMPILATION_OUTPUT)/core.dmp -Xdump:jit:file=$(COMPILATION_OUTPUT)/jitdump" $(COMPILE_CMD) 2>&1; echo $$? ) | tee $(Q)$(COMPILATION_LOG)$(Q); \
	$(MOVE_TDUMP)
