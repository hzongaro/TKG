...
compile:
	...
	(ANT_OPTS="-Xnoaot -Xjit:limitFile=\($(COMPILATION_OUTPUT)/exclude.list,1,40\),{java/util/Hashtable.put*}\(log=$(COMPILATION_OUTPUT)/hashtable.log,traceLocalVP,traceGlobalVP,traceCG\),verbose,vlog=$(COMPILATION_OUTPUT)/vlog" $(COMPILE_CMD) 2>&1; echo $$? ) | tee $(Q)$(COMPILATION_LOG)$(Q); \
	$(MOVE_TDUMP)
